        ...
        OkHttpUtils
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        ...
                        getSupportFragmentManager().beginTransaction().add(R.id.container_online_p, new PlaceholderLiveFragment(0, 0, 0)).commit();
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        try {
                            ...
                            getSupportFragmentManager().beginTransaction().add(R.id.container_online_p, new PlaceholderLiveFragment(all, yes, no)).commit();
                            closeProgressDialog();
